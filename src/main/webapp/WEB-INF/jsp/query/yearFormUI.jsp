  ...
  <s:debug></s:debug>
  	<table border="1" cellspacing="0" style="border:#A9A9A9 1px solid;">
  		...
  		<tr>
  			...
  			<s:if test="#i.index==0">
	  			<s:iterator value="%{#request.record0}" id="yearRecord0">
	  				<td align="center">
  			...
  			<s:elseif test="#i.index==1">
  				<s:iterator value="%{#request.record1}" id="yearRecord1">
	  				<td align="center">
  			...
  			<s:elseif test="#i.index==2">
  				<s:iterator value="%{#request.record2}" id="yearRecord2">
	  				<td align="center">
  			...
  			<s:elseif test="#i.index==3">
  				<s:iterator value="%{#request.record3}" id="yearRecord3">
	  				<td align="center">
  			...
  			<s:elseif test="#i.index==4">
  				<s:iterator value="%{#request.record4}" id="yearRecord4">
	  				<td align="center">
  			...
  			<s:elseif test="#i.index==5">
  				<s:iterator value="%{#request.record5}" id="yearRecord5">
	  				<td align="center">
